                    ...
                    .overlay {
                        ZStack {
                            Path() { path in
                                ...
                                path.addLine(to: .init(x: 100 * 2 + viewStore.state.model.accelerationX / 27 * 2, y: 100 * 2 + viewStore.state.model.accelerationY / 27 * 2))
                            }
                            .stroke(lineWidth: 1)
                            .fill(Color.red)
                            ...
                            Circle()
                                ...
                                .position(x: 100 * 2 + viewStore.state.model.accelerationX / 27 * 2, y: 100 * 2 + viewStore.state.model.accelerationY / 27 * 2)
                        }
                        .clipped()
